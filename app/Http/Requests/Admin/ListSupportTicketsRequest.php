...
final class ListSupportTicketsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sort' => ['nullable', Rule::in(['reference', 'subject', 'priority', 'status', 'created_at', 'last_activity_at'])],
    ...
    {
        $sorts = ['reference', 'subject', 'priority', 'status', 'created_at', 'last_activity_at'];
        $directions = ['asc', 'desc'];
        ...
        $this->merge([
            ...
            'visibility' => is_string($this->visibility) && in_array($this->visibility, $visibility, true) ? $this->visibility : 'active',
