...
- **Vector search:** MySQL JSON embeddings behind `VectorStore`; exact cosine scoring runs in PHP after strict tenant/bot SQL filtering. This is the approved architecture unless the product owner explicitly changes it.
...
- Replacing the approved MySQL vector-store architecture.
